<div class="container-fluid">
  <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
    <div>
      ...
      <div class="text-muted small">Administra las unidades de medida.</div>
    </div>
    <div class="ms-auto page-actions">
      <a class="btn btn-primary" href="<?= base_url('/unidades/nuevo/') ?>">Agregar unidad</a>
      <a class="btn btn-outline-secondary" href="<?= base_url('/unidades/eliminados/') ?>">Eliminadas</a>
    </div>
  </div>

  <div class="card">
    <div class="card-header">Listado de unidades</div>
          ...
          <tbody>
            <?php foreach ($datos as $dato) : ?>
              <tr>
                ...
                <td class="text-end">
                  <a href="<?= base_url('/unidades/editar/' . $dato['id']) ?>" class="btn btn-sm btn-outline-primary">Editar</a>
                  <a href="#"
