...
<main class="container-fluid p-3 p-lg-4">
    ...
    <div class="container-fluid p-3 p-lg-4">
        ...
        <form action="<?= site_url('compras/guarda') ?>" method="post" autocomplete="off">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-4">
                        ...
                        <input class="form-control" id="precio_compra" name="precio_compra" type="text" placeholder="Escreibe el precio de compra y presiona enter" readonly>
                    </div>
                    <div class="col-12 col-sm-4">
                    ...
                    <div class="col-12 col-sm-4">
                        <label><br>&nbsp;</label>
                        <button class="btn btn-primary" id="agregar_producto" name="agregar_producto" type="button" onclick="agregarProducto(id_producto.value, cantidad.value, <?= $id_compra ?>)">Agregar producto</button>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 offset-md-6">
                            ...
                            <button type="button" id="CompletarCompra" class="btn btn-success">Completar compra</button>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function agregarProducto(e, tagCodigo, codigo) {
