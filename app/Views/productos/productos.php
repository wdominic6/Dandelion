<div class="container-fluid">
  <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
    <div>
      ...
      <div class="text-muted small">Gestiona el catalogo de productos.</div>
    </div>
    <div class="ms-auto page-actions">
      <a class="btn btn-primary" href="<?= base_url('/productos/nuevo/') ?>">Agregar producto</a>
      <a class="btn btn-outline-secondary" href="<?= base_url('/productos/eliminados/') ?>">Eliminados</a>
    </div>
  </div>
          ...
          <tbody>
            <?php foreach ($datos as $dato) : ?>
              <tr>
                ...
                <td class="text-end">
                  <a href="<?= base_url('/productos/editar/' . $dato['id']) ?>" class="btn btn-sm btn-outline-primary">Editar</a>
                  <a href="#"
