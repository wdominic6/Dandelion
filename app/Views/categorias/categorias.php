<div class="container-fluid">
  <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
    <div>
      ...
      <div class="text-muted small">Organiza tus categorias de productos.</div>
    </div>
    <div class="ms-auto page-actions">
      <a class="btn btn-primary" href="<?= base_url('/categorias/nuevo/') ?>">Agregar categoria</a>
      <a class="btn btn-outline-secondary" href="<?= base_url('/categorias/eliminados/') ?>">Eliminadas</a>
    </div>
  </div>
          ...
          <tbody>
            <?php foreach ($datos as $dato) : ?>
              <tr>
                ...
                <td class="text-end">
                  <a href="<?= base_url('/categorias/editar/' . $dato['id']) ?>" class="btn btn-sm btn-outline-primary">Editar</a>
                  <a href="#"
                     data-href="<?= base_url('/categorias/eliminar/' . $dato['id']) ?>"
