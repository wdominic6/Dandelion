<div class="container-fluid">
  <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
    <div>
      ...
      <div class="text-muted small">Clientes marcados como eliminados.</div>
    </div>
    <div class="ms-auto page-actions">
      <a href="<?= base_url('/clientes') ?>" class="btn btn-outline-secondary">Volver a clientes</a>
    </div>
  </div>

  <div class="card">
    <div class="card-header">Clientes eliminados</div>
